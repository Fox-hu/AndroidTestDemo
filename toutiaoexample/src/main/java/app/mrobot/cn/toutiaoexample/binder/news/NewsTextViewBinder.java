...
public class NewsTextViewBinder extends ItemViewBinder<MultiNewsArticleDataBean, NewsTextViewBinder.ViewHolder> {

    @NonNull
    @Override
    protected NewsTextViewBinder.ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater,
    ...
    @Override
    protected void onBindViewHolder(@NonNull final NewsTextViewBinder.ViewHolder holder,
