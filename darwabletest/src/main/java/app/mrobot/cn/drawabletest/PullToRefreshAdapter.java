...
import app.mrobot.cn.drawabletest.util.SpannableStringUtils;
import app.mrobot.cn.drawabletest.util.ToastUtils;
...
public class PullToRefreshAdapter extends BaseQuickAdapter<Status, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, Status item) {
        ...
        ((TextView) helper.getView(R.id.tweetText)).setText(
                SpannableStringUtils.getBuilder(msg).append("landscapes and nedes").setClickSpan(clickableSpan).create());
