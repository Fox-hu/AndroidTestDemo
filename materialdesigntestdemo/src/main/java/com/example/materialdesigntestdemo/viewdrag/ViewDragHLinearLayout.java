package com.example.materialdesigntestdemo.viewdrag;
...
public class ViewDragHLinearLayout extends ViewGroup {
    ...
    public ViewDragHLinearLayout(Context context) {
        super(context);
        init();
    }

    public ViewDragHLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ViewDragHLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class ViewDragHelperCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            mMenuView.setVisibility(
                    (changedView.getHeight() - top == getHeight()) ? View.GONE : View.VISIBLE);
            mCurrentTop += dy;
            requestLayout();
        }
